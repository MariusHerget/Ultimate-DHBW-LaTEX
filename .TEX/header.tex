...
\renewcommand*\FXLayoutInline[3]{%
  {
	\ifthenelse{\equal{#1}{note}}{ % TBD
		\@fxuseface{inline}\ignorespaces\textit{\impmark\color{orange}[TBD: #2]}
		}{}
	\ifthenelse{\equal{#1}{warning}}{ % TBD without describtion
		\@fxuseface{inline}\ignorespaces\textit{\impmark\color{orange}\textbf{TBD}}
		}{}
	\ifthenelse{\equal{#1}{fatal}}{ % Question
		\@fxuseface{inline}\ignorespaces\textit{\impquest\color{red}[Question: #2]}
		}{}
	}}
% Appendix
